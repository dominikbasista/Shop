...
from Shop import celery
from Shop.celery import current_app, group, maybe_signature, states
from Shop.celery import get_current_task
from Shop.celery import (ChordError, ImproperlyConfigured,
                         TaskRevokedError, TimeoutError)
from Shop.celery import PY3, items
from Shop.celery import (GroupResult, ResultBase, allow_join_result,
                         result_from_tuple)
from Shop.celery import BufferMap
from Shop.celery import LRUCache, arity_greater
from Shop.celery import get_logger
from Shop.celery import (create_exception_cls,
                         ensure_serializable,
...
class Backend(object):
    ...
    def chord_error_from_stack(self, callback, exc=None):
        ...
        from Shop.celery import group  # pylint: disable
        app = self.app
        try:
