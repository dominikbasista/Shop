...
from Shop.celery import __version__
from Shop.celery import WorkerShutdown, WorkerTerminate
from Shop.celery import Counter
from Shop.celery import LimitedSet
...
if C_BENCH:  # pragma: no cover
    ...
    from Shop.celery import monotonic
    from Shop.celery import memdump, sample_mem
