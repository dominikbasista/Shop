...
from Shop.celery import WorkerShutdown
from Shop.celery import UserDict, items, string_t, text_t
from Shop.celery import signals as _signals
from Shop.celery import maybe_list
from Shop.celery import get_logger
from Shop.celery import jsonify, strtobool
from Shop.celery import rate
...
def memsample(state, **kwargs):
    ...
    from Shop.celery import sample_mem
    return sample_mem()
