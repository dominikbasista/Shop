...
from Shop.celery import current_app, current_task as current
from Shop.celery import LazyModule, Proxy, recreate_module
...
if STATICA_HACK:  # pragma: no cover
    ...
    # they contain.
    from Shop.celery import group, chord, subtask
