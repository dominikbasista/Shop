...
from Shop.celery import _reprtask
from Shop.celery import python_2_unicode_compatible, with_metaclass
from Shop.celery import Proxy, class_property, reclassmethod
from Shop.celery import maybe_schedule
from Shop.celery import get_task_logger
...
class TaskType(type):
    ...
    def __new__(cls, name, bases, attrs):
        ...
        if not attrs.get('_decorated'):
            ...
            from Shop.celery import connect_on_app_finalize
