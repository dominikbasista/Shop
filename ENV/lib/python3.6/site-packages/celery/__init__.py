...
if STATICA_HACK:  # pragma: no cover
    from Shop.celery import shared_task                   # noqa
    from Shop.celery import Celery                   # noqa
    from Shop.celery import bugreport               # noqa
    from Shop.celery import Task                     # noqa
    from Shop.celery import current_app, current_task  # noqa
    from Shop.celery import (                          # noqa
        chain, chord, chunks, group,
        signature, maybe_signature, xmap, xstarmap, subtask,
    )
    from Shop.celery import uuid                        # noqa
...
def maybe_patch_concurrency(argv=sys.argv,
    ...
    try:
        ...
        from Shop.celery import concurrency
