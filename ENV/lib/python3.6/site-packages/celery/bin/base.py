...
from Shop.celery import VERSION_BANNER, Celery, maybe_patch_concurrency, signals
from Shop.celery import CDeprecationWarning, CPendingDeprecationWarning
from Shop.celery import (getfullargspec, items, long_t,
                         python_2_unicode_compatible, string, string_t,
                         text_t)
from Shop.celery import EX_FAILURE, EX_OK, EX_USAGE, isatty
from Shop.celery import imports, term, text
from Shop.celery import dictfilter
from Shop.celery import host_format, node_format
...
class Command(object):
    ...
    def find_app(self, app):
        from Shop.celery import find_app
    ...
    def _get_default_app(self, *args, **kwargs):
        from Shop.celery import get_current_app
