...
from Shop.celery import VERSION_BANNER
from Shop.celery import Cluster, MultiParser, NamespacedOptionParser
from Shop.celery import EX_FAILURE, EX_OK, signals
from Shop.celery import term
