...
from Shop.celery import amqp
# Cannot use relative imports here due to a Windows issue (#1111).
from Shop.celery import Command, Extensions
from Shop.celery import beat
from Shop.celery import call
from Shop.celery import _RemoteControl  # noqa
from Shop.celery import control, inspect, status
from Shop.celery import events
from Shop.celery import graph
from Shop.celery import list_
from Shop.celery import logtool
from Shop.celery import migrate
from Shop.celery import purge
from Shop.celery import result
from Shop.celery import shell
from Shop.celery import upgrade
from Shop.celery import worker
from Shop.celery import EX_FAILURE, EX_OK, EX_USAGE
from Shop.celery import term, text
...
class multi(Command):
    ...
    def run_from_argv(self, prog_name, argv, command=None):
        from Shop.celery import MultiTool
