...
from Shop.celery import platforms, signals
from Shop.celery import (_announce_app_finalized, _deregister_app,
                         _register_app, _set_current_app, _task_stack,
                         connect_on_app_finalize, get_current_app,
                         get_current_worker_task, set_default_app)
from Shop.celery import AlwaysEagerIgnored, ImproperlyConfigured
from Shop.celery import (UserDict, bytes_if_py2, python_2_unicode_compatible,
                         values)
from Shop.celery import get_loader_cls
from Shop.celery import PromiseProxy, maybe_evaluate
from Shop.celery import abstract
from Shop.celery import AttributeDictMixin
from Shop.celery import Signal
from Shop.celery import first, head_from_fun, maybe_list
from Shop.celery import gen_task_name, instantiate, symbol_by_name
from Shop.celery import get_logger
from Shop.celery import FallbackContext, mro_lookup
from Shop.celery import (get_exponential_backoff_interval, timezone,
                         to_utc)
...
class Celery(object):
    ...
    def setup_security(self, allowed_serializers=None, key=None, cert=None,
        ...
        """
        from Shop.celery import setup_security
    ...
    @cached_property
    def _canvas(self):
        from Shop.celery import canvas
        return canvas
