...
from Shop.celery import current_app, group, signals, states
from Shop.celery import _task_stack
from Shop.celery import Context
from Shop.celery import Task as BaseTask
from Shop.celery import Ignore, InvalidTaskError, Reject, Retry
from Shop.celery import monotonic, text_t
from Shop.celery import get_logger
from Shop.celery import gethostname
from Shop.celery import mro_lookup
from Shop.celery import saferepr
from Shop.celery import (get_pickleable_etype,
...
def setup_worker_optimizations(app, hostname=None):
    ...
    from Shop.celery import request as request_module
