...
from Shop.celery import current_app, group, states
from Shop.celery import _task_stack
from Shop.celery import signature
from Shop.celery import (Ignore, ImproperlyConfigured,
                         MaxRetriesExceededError, Reject, Retry)
from Shop.celery import items, python_2_unicode_compatible
from Shop.celery import class_property
from Shop.celery import EagerResult, denied_join_result
from Shop.celery import abstract
from Shop.celery import mattrgetter, maybe_list
from Shop.celery import instantiate
from Shop.celery import gethostname
from Shop.celery import raise_with_context
...
class Task(object):
    ...
    def bind(cls, app):
        ...
        if not was_bound:
            ...
            from Shop.celery import LocalStack
    ...
    def apply(self, args=None, kwargs=None,
        ...
        from Shop.celery import build_tracer
