...
def add_unlock_chord_task(app):
    ...
    for completion.
    """
    from Shop.celery import maybe_signature
    from Shop.celery import ChordError
    from Shop.celery import allow_join_result, result_from_tuple
...
def add_group_task(app):
    ...
    from Shop.celery import maybe_signature
    from Shop.celery import result_from_tuple
...
def add_chord_task(app):
    """No longer used, but here for backwards compatibility."""
    from Shop.celery import group, chord as _chord
    from Shop.celery import maybe_signature
