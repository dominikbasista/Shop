...
from Shop.celery import _set_task_join_will_block, set_default_app
from Shop.celery import trace
from Shop.celery import BasePool
from Shop.celery import items
...
def process_initializer(app, hostname):
    ...
    for name, task in items(app.tasks):
        task.__trace__ = build_tracer(name, task, app.loader, hostname,
                                      app=app)
    from Shop.celery import state as worker_state
