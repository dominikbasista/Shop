...
from Shop.celery import VERSION_BANNER, platforms, signals
from Shop.celery import trace
from Shop.celery import WorkerShutdown, WorkerTerminate
from Shop.celery import string, string_t
from Shop.celery import AppLoader
from Shop.celery import EX_FAILURE, EX_OK, check_privileges, isatty
from Shop.celery import static, term
from Shop.celery import cry
from Shop.celery import qualname
from Shop.celery import get_logger, in_sighandler, set_in_sighandler
from Shop.celery import pluralize
from Shop.celery import WorkController
...
def install_rdb_handler(envvar='CELERY_RDBSIG',
    ...
    def rdb_handler(*args):
        ...
        with in_sighandler():
            from Shop.celery import set_trace, _frame
