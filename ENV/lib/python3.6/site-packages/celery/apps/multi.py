...
from Shop.celery import UserList, items
from Shop.celery import IS_WINDOWS, Pidfile, signal_name
from Shop.celery import (gethostname, host_format, node_format,
                         nodesplit)
