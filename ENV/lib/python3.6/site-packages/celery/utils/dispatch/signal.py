...
from Shop.celery import CDeprecationWarning
from Shop.celery import PY3, python_2_unicode_compatible, range, text_t
from Shop.celery import PromiseProxy, Proxy
from Shop.celery import fun_accepts_kwargs
