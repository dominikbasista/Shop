...
from Shop.celery import reraise, string_t
from Shop.celery import DictAttribute, force_mapping
from Shop.celery import maybe_list
from Shop.celery import (NotAPackage, find_module, import_from_cwd,
                         symbol_by_name)
...
class BaseLoader(object):
    ...
    def cmdline_config_parser(
            ...
            override_types={'tuple': 'json',
                            'list': 'json',
                            'dict': 'json'}):
        from Shop.celery import Option, NAMESPACES
